...
public class OAuth2ResourceServerController {
    ...
    public String index(@AuthenticationPrincipal Jwt jwt) {
       return jwt.getClaimAsString("preferred_username") + " is list all products";
    }

    @PostMapping("/products")
    public String premium(@AuthenticationPrincipal Jwt jwt) {
        return jwt.getClaimAsString("preferred_username") + " is create a product";
    }

    @GetMapping("/users")
    public String ss(@AuthenticationPrincipal Jwt jwt) {
